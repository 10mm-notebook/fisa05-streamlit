...
fig=px.bar(df,x="command",y="rating",color="command",labels={"command":"x축 제목","rating":"Rating"},title="Command Rating Bar Chart")
...
st.write(True if country == 'France' or country == 'Germany' else False)
...
# picture = st.camera_input('Click a Snap')
# st.download_button('Download Source data', picture, file_name='photo.png', mime='image/png')
